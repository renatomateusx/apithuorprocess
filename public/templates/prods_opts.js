...
class CheckoutMP extends HTMLElement {
    ...
    initializeFunction() {
        ...
        const btnAcao = this._shadowRoot.getElementById("btnAcao");
        ...
        direct_to_checkout = this.getAttribute("direct_to_checkout");
...
customElements.define('thuor-opcoes', CheckoutMP);